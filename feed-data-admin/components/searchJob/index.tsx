...
import { Card, Button, Row, Col, Table, Form, Select, DatePicker, Alert } from 'antd'
  ...
  const columns = [
    {
      ...
      render: text => <a onClick={() => { setIsModalVisible(true) }}>{text}</a>
    },
    {
      title: 'Job Type',
      dataIndex: 'jobType',
  ...
  return (
        <>
            <Card title="Job List">
                ...
                <JobDetail isModalVisible={isModalVisible} setIsModalVisible={setIsModalVisible} />
            </Card>
        </>
  )
}
